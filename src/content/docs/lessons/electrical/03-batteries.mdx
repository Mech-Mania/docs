...
* **Do not undercharge:** Doing so will ruin the internal chemistry of the battery and will make it unusable.
* **Use a LiPo Bag:** If you have access to a LiPo bag, please use it while charging. If an accident ever happens, the bag will contain the flames and slow down the damage. 
